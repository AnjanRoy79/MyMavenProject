...
public class OHRM_UsingExcel {
	
	String fPath = "D:\\Anjan-SeleniumDemos\\Practise_WebDriver\\ExcelFiles\\LoginData1.xlsx";
	File file;
	FileInputStream fis;
	...
	public void afterMethod() {
		...
		//if(result)
		if(sheet.getRow(index).getCell(8).getStringCellValue().equals(sheet.getRow(index).getCell(7).getStringCellValue()))
		{
